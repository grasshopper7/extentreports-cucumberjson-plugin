...
public class ExtentTestHeirarchyTest {
	...
	public void testNewFeatureCreation() {
		...
		Feature feature = (new FeatureBuilder())
				.setUri(uri).setName(name).setDescription(description)
				.setStartTime(startTime).setEndTime(endTime)
				.addFeatureTag(tagName1).addFeatureTag(tagName2)
				.build();
		...
		assertEquals("Test categories are not correct.", Arrays.asList(tagName1, tagName2),
				model.getCategoryContext().getAll().stream().map(t -> t.getName()).collect(Collectors.toList()));
	...
	public void testNewFeatureWithNoTagsCreation() {
		...
		assertEquals("Test name is not correct.", name, model.getName());
		assertTrue("Test categories are not empty.", model.getCategoryContext().getAll().isEmpty());
		assertEquals("Test start time is not correct.", DateConverter.parseToDate(startTime), model.getStartTime());
		assertEquals("Test end time is not correct.", DateConverter.parseToDate(endTime), model.getEndTime());
	}
	...
	public void testRepeatFeatureCreation() {
		String name = "Feature Name";		
		Feature feature = (new FeatureBuilder())
				.setUri("classpath:features/urisample.feature")
				.setName(name)
				.setStartTime("2020-06-20T12:30:15.654Z")
				.setEndTime("2020-06-20T12:30:16.123Z")
				.build();

		ExtentTest featureExtentTest = extentTestHeirarchy.createFeatureExtentTest(feature);

		Feature featureRepeat = (new FeatureBuilder())
				.setUri("classpath:features/urisample.feature")
				.setName(name)
				.build();
	...
	public void testNewScenarioCreation() {
		...
		Feature feature = (new FeatureBuilder())
				.setUri("classpath:features/urisample.feature").setName("Feature Name")
				.addScenario().setScenarioKeyword("scenario")
				.setScenarioName(name).setScenarioDescription(description)
				.addScenarioTag(tagName1).addScenarioTag(tagName2)
				.build();

		ExtentTest scenarioExtentTest = extentTestHeirarchy.createScenarioExtentNode(parentFeatureExtentTest, feature.getElements().get(0));
	...
	public void testMultipleNewScenarioCreation() {
		...
		Feature feature = (new FeatureBuilder())
				...
				.addScenario().setScenarioKeyword("scenario")
				.setScenarioName("Scenario Name Repeat")
				.build();
	...
	public void testNewScenarioOutlineCreation() {
		...
		Feature feature = (new FeatureBuilder())
				.setUri("classpath:features/urisample.feature").setName("Feature Name")
				.addScenario().setScenarioKeyword("scenario outline")
				.setScenarioName(name).setScenarioDescription(description)
				.setScenarioId("Feature-Name;Scenario-Outline-Name;Examples-Name;2")
				.setScenarioUriStepLines("classpath:features/urisample.feature" + ":5:6:7")
				.build();
		...
		List<com.aventstack.extentreports.model.Test> scenarioTest = scenarioOutlineTest.get(0).getNodeContext()
				.getAll();
	...
	public void testMultipleScenarioForSingleScenarioOutlineCreation() {
		...
		Feature feature = (new FeatureBuilder())
				.setUri("classpath:features/urisample.feature").setName("Feature Name")
				.addScenario().setScenarioKeyword("scenario outline")
				.setScenarioName("Scenario Outline Name")
				.setScenarioId("Feature-Name;Scenario-Outline-Name;Examples-Name;2")
				.setScenarioUriStepLines("classpath:features/urisample.feature" + ":5:6:7")
				.addScenario().setScenarioKeyword("scenario outline")
				.setScenarioName("Scenario Outline Name Repeat")
	...
	public void testMultipleScenarioOutlineCreation() {
		...
		Feature feature = (new FeatureBuilder())
				.setUri("classpath:features/urisample.feature").setName("Feature Name")
				.addScenario().setScenarioKeyword("scenario outline")
				.setScenarioName("Scenario Outline Name First")
				.setScenarioId("Feature-Name;Scenario-Outline-Name;Examples-Name;10")
				.setScenarioUriStepLines("classpath:features/urisample.feature" + ":15:16:17")
				.addScenario().setScenarioKeyword("scenario outline")
				.setScenarioName("Scenario Outline Name Second")
				.setScenarioId("Feature-Name;Scenario-Outline-Name;Examples-Name;20")
				.setScenarioUriStepLines("classpath:features/urisample.feature" + ":25:26:27")
				.build();
		...
		List<com.aventstack.extentreports.model.Test> scenarioFirstTest = scenarioOutlineTest.get(0).getNodeContext()
				.getAll();
		assertEquals("Number of child nodes of First Scenario Outline Test should be 1", 1, scenarioFirstTest.size());

		List<com.aventstack.extentreports.model.Test> scenarioSecondTest = scenarioOutlineTest.get(1).getNodeContext()
				.getAll();
	...
	public void testSinglePassedStepCreation() {
		...
		Feature feature = (new FeatureBuilder())
				...
				.addScenario().setScenarioKeyword("scenario")
				.setScenarioName("Scenario Name")
				.addStep().setStepKeyword(keyword).setStepText(stepText)
				.setStepLocation(location).setStepResult(status)
				.build();

		ExtentTest stepExtentTest = extentTestHeirarchy.createStepExtentNode(scenarioExtentTest, feature.getElements().get(0).getSteps().get(0));

		List<com.aventstack.extentreports.model.Test> scenarioChilds = scenarioExtentTest.getModel().getNodeContext()
				.getAll();
		...
		assertEquals("Step keyword is not correct.", keyword.trim(), stepTest.getBehaviorDrivenTypeName());
	...
	public void testMultipleSkippedAndFailedStepCreation() {
		...
		Feature feature = (new FeatureBuilder())
				...
				.addScenario().setScenarioKeyword("scenario")
				.setScenarioName("Scenario Name")
				.addStep().setStepKeyword("When ").setStepText("Step text for \u0027when\\u0027 step")
				.setStepLocation("stepdefs.Stepdefs.stepWhen(java.lang.String)")
				.setStepResult("failed").setStepErrorMessage("Error Message")
				.addStep().setStepKeyword("Then ").setStepText("Step text for \u0027then\\u0027 step")
		...
		ExtentTest stepWhenExtentTest = extentTestHeirarchy.createStepExtentNode(scenarioExtentTest, feature.getElements().get(0).getSteps().get(0));
		assertEquals("Step status is not correct.", "FAIL", stepWhenExtentTest.getStatus().name());

		ExtentTest stepThenExtentTest = extentTestHeirarchy.createStepExtentNode(scenarioExtentTest, feature.getElements().get(0).getSteps().get(1));
	...
	public void testStepWithMessageCreation() {
		...
		Feature feature = (new FeatureBuilder())
				...
				.addScenario().setScenarioKeyword("scenario")
				.setScenarioName("Scenario Name")
				.addStep().setStepKeyword("Given ").setStepText("Step text to test")
				.setStepLocation("stepdefs.Stepdefs.step()").setStepResult("passed")
				.setStepOutput(Arrays.asList("Information One", "Information Two"))
				.build();

		ExtentTest stepExtentTest = extentTestHeirarchy.createStepExtentNode(scenarioExtentTest, feature.getElements().get(0).getSteps().get(0));
		List<Log> logs = stepExtentTest.getModel().getLogContext().getAll();
	...
	public void testSingleHookCreation() {
		...
		List<ExtentTest> hooksExtentTest = extentTestHeirarchy.createBeforeHookExtentNodes(scenarioExtentTest,
				scenario);
		List<com.aventstack.extentreports.model.Test> scenarioHooks = scenarioExtentTest.getModel().getNodeContext()
				.getAll();
